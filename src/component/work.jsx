              ...
              <div className="mt-8 flex flex-col gap-2">
                ...
                <div className="flex justify-between items-end gap-4">
                  ...
                  <Link
                    ...
                    className="font-sans px-7 py-3 rounded-full bg-gradient-to-r from-[#6322E0] to-[#9B32FF] text-white text-sm font-semibold shadow-[0_10px_20px_rgba(99,34,224,0.3)] hover:shadow-[0_15px_30px_rgba(155,50,255,0.5)] hover:-translate-y-1 transition-all duration-300"
                  >
                    View Case Study
                  </Link>
                </div>
